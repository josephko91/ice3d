...
#PBS -A UCLB0047
#PBS -N test-save-2
#PBS -o ./out/projections-mp/out-test-save-2.log 
#PBS -e ./err/projections-mp/error-test-save-2.log
#PBS -m abe
#PBS -q main  
...
n_proj=10
n_cores=1000
save_dir="/glade/derecho/scratch/joko/synth-ros/test-save-empty"
