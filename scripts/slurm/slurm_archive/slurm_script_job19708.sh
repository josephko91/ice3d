#!/bin/bash
#SBATCH --job-name=resnet-cls-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-training/out-21.log
#SBATCH --error=./err/torch-training/err-21.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="resnet18-classification-subset-700k-tb"
CSV_LOG_NAME="resnet18-classification-subset-700k-csv"
