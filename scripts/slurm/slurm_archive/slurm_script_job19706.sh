#!/bin/bash
#SBATCH --job-name=resnet-cls-stereo-phips-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-training/out-20.log
#SBATCH --error=./err/torch-training/err-20.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
HDF_FILE_RIGHT="/home/jko/synth-ros-data/imgs-ml-ready/shuffled_small/phips_shuffled_small.h5"
TARGETS="n_arms"
INPUT_CHANNELS=2
BATCH_SIZE=128
LR=1e-3
...
TB_LOG_NAME="resnet18-classification-stereo-phips-subset-700k-tb"
CSV_LOG_NAME="resnet18-classification-stereo-phips-subset-700k-csv"
