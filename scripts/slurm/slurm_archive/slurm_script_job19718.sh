#!/bin/bash
#SBATCH --job-name=resnet-reg-stereo-phips-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-training/out-24.log
#SBATCH --error=./err/torch-training/err-24.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="resnet18-regression-stereo-phips-subset-700k-tb"
CSV_LOG_NAME="resnet18-regression-stereo-phips-subset-700k-csv"
