#!/bin/bash
#SBATCH --job-name=resnet-reg-stereo-2ds-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-training/out-23.log
#SBATCH --error=./err/torch-training/err-23.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="resnet18-regression-stereo-2ds-subset-700k-tb"
CSV_LOG_NAME="resnet18-regression-stereo-2ds-subset-700k-csv"
