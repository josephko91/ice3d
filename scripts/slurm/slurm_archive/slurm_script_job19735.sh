#!/bin/bash
#SBATCH --job-name=mlp-reg-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-v100/out-10.log
#SBATCH --error=./err/torch-v100/err-10.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="mlp-regression-subset-700k-tb"
CSV_LOG_NAME="mlp-regression-subset-700k-csv"
