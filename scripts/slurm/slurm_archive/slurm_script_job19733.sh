#!/bin/bash
#SBATCH --job-name=mlp-cls-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-v100/out-09.log
#SBATCH --error=./err/torch-v100/err-09.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="mlp-classification-subset-700k-tb"
CSV_LOG_NAME="mlp-classification-subset-700k-csv"
