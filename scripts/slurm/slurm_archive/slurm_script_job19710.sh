#!/bin/bash
#SBATCH --job-name=cnn-cls-b128-e50
#SBATCH --account=ai2es_premium
#SBATCH --output=./out/torch-v100/out-01.log
#SBATCH --error=./err/torch-v100/err-01.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TB_LOG_NAME="cnn-classification-subset-700k-tb"
CSV_LOG_NAME="cnn-classification-subset-700k-csv"
