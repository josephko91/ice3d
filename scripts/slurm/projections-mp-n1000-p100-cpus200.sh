#!/bin/bash
#PBS -A UPSU0052
#PBS -N projections-mp-n1000-p100-cpus200
#PBS -o ./out/projections-mp/output-n1000-p100-cpus200.log 
#PBS -e ./err/projections-mp/error-n1000-p100-cpus200.log
#PBS -m abe
#PBS -q main  
#PBS -l select=2:ncpus=100
