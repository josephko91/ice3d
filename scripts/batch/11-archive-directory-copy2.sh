...
OUTPUT_FILE="/glade/derecho/scratch/joko/synth-ros/params_200_50_20250403-archive-20250417-16cores.tar.zst"

# Create the tar archive with zstd compression
echo "Archiving directory: $SOURCE_DIR"
tar --use-compress-program="zstd -T16 --fast" -cf "$OUTPUT_FILE" -C "$(dirname "$SOURCE_DIR")" "$(basename "$SOURCE_DIR")"
